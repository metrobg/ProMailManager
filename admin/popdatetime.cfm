...
TagName:        <cf_popDateTime> v2.0

Author:		      Eddy Blanco / eddyblanco@earthlink.net 
Created:	      April 12, 2003
Notes:		I did not include any of the other scripts that include the
		time or european date format I have only include mm/dd/yyyy
		format: I have included date Validation 
		...
		This custom tag generates a formfield and popup window
                allowing users to pick a date clicking on and easy to navigate 
		calendar.  
...
<cfscript>
  ...
  // calendar image file
  variables.imgFile = variables.scriptPath & 'cal.gif';
  
  // here we concatenate variables and strings to construct javascript call      
  variables.javaScriptCall = "javascript:show_calendar" & variables.scriptNo & "('document." & variables.formName & "." & variables.fieldName & "', document." & variables.formName & "." & variables.fieldName & ".value, '" & variables.scriptPath & "');";
...
<cfoutput>
  ...
  <script language="JavaScript" src="#variables.scriptFile#"></script>     
   
  <!--- this is the form field and the calendar image --->
  <cfparam name="ATTRIBUTES.classStyle" default="">
  <cfparam name="ATTRIBUTES.maxLength" default="10">
  <cfparam name="ATTRIBUTES.size" default="8">
  <cfparam name="ATTRIBUTES.defaultDate" default="">
  <cfif Len(ATTRIBUTES.defaultDate) gte 6>
  	<cfset variables.fieldValue = #ATTRIBUTES.defaultDate#>
  </cfif>
  <input type="Text" class="#ATTRIBUTES.classStyle#" maxlength="#ATTRIBUTES.maxLength#" size="#ATTRIBUTES.size#"  name="#variables.fieldName#" value="#variables.fieldValue#" onFocus="javascript:vDateType='3'" onKeyUp="DateFormat(this,this.value,event,false,'1')" onBlur="DateFormat(this,this.value,event,true,'1')">
  <a href="#variables.javaScriptCall#"><img src="#variables.imgFile#" align="absmiddle" 
                                              width="16" 
                                              height="16" 
                                              border="0" 
