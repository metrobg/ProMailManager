		...
		<cf_nextn recordcount="#qSubscriberGroup.RecordCount#" resultsperpage="#globals.subscribersList_MaxRows#">
		
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<!--- Group name retrieved display --->
			<tr>
			  <td colspan="15" class="bodyText">
			  <table width="90%" border="0" cellpadding="2" cellspacing="0" bgcolor="#B1B163" align="center">
			    <tr>
			      <td><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
			        <tr>
			          <td height="22" align="center" class="bodyText">Current Subscriber
			            Group Displayed: <strong><cfif IsDefined("qSubscriberGroupName") AND qSubscriberGroupName.RecordCount eq 1><cfoutput>#qSubscriberGroupName.GroupDesc#</cfoutput><cfelse> -undefined- </cfif></strong>
						</td>
			          </tr>
		          </table></td>
		        </tr>
			...
			<tr>
			  <td colspan="15" class="bodyText">
					...
					<cfif qSubscriberGroup.RecordCount gt globals.subscribersList_MaxRows>
					<tr>
						<td height="22" align="left" class="bodyText">
						Page: [ <cf_pagelinks displaypagelinks="Yes" displaypageinput="No" displaypreviousnext="No" querystring="lid=#lid#&Group=#Group#&bRetrieveGroup=1"> ] <cf_pagelinks displaypagelinks="No" displaypageinput="No" displaypreviousnext="Yes" querystring="lid=#lid#&Group=#Group#&bRetrieveGroup=1">
						</td>
					</tr>
					</cfif>
					<tr>
			...
			<tr>
			  <td height="1" colspan="15" nowrap class="tdHorizDivider"><img src="../images/spacer_transparent.gif" width="1" height="1"></td>
			</tr>
			<tr>
			  <td align="center" nowrap class="tdBackGrnd"><strong>Include</strong></td>
			...
			<cfloop query="qSubscriberGroup" startrow="#REQUEST.StartRow#" endrow="#REQUEST.EndRow#">
			 <cfoutput>
			  <cfform action="#cgi.script_name#" method="post">
				<input type="hidden" name="lid" value="#lid#">
				<input type="hidden" name="egmid" value="#GMID#">
				<input type="hidden" name="Group" value="#Group#">
				<input type="hidden" name="bRetrieveGroup" value="1">
				<input type="hidden" name="CurrentPageNum" value="#PageNum#">
				<tr>
				  <td align="center" nowrap class="bodyText"><input type="checkbox" name="IncludeInBroadcast" value="1" class="bodyText" checked></td>
				  <td width="1" class="tdVertDivider"><img src="../images/spacer_transparent.gif" width="1" height="1"></td>
				...
				<tr>
				  <td height="1" colspan="15" class="tdVertDivider"><img src="../images/spacer_transparent.gif" width="1" height="1"></td>
				</tr>
			  </cfform>
			</cfoutput>
			</cfloop>
			...
			<tr>
				<td height="30" colspan="15" align="center" valign="middle" class="bodyText">
