...
Date Last Modified:        November 30, 2003
=====================================================================
 -->
...
<html>
<head>
<title>Mail List: Create New Message</title>
        ...
        <tr>
          <td>
            <table width="100%" border="0" cellpadding="3" cellspacing="0">
              <tr>
                <td align="center" background="images/gradient-bar-dark-blue.gif" class="tdTipsHeader"><strong>HTML Message
                    Import</strong></td>
              </tr>
              <tr>
                <td align="center" bgcolor="#FFFFFF"><p><span class="bodyText"><img src="../images/icon-help.gif" width="24" height="25"><br>
                    Click to
                    import a full HTML page from your web site or another directly
                        into your HTML Message.<br>
                        <strong>Be Sure to enter the FULL URL</strong>  ( no
                        trailing / and no http://) i.e:<br>
                    <font color="#FF0000">www.cnn.com</font></span></p>
                  <form action="messageNew.cfm?lid=<cfoutput>#lid#</cfoutput>" method="post">
				  	<span class="bodyText">			  	    
					Editor Status: <input type="radio" name="ShowEditor" value="1" class="bodyText">On <input type="radio" name="ShowEditor" checked value="0" class="bodyText">Off</span>	
					<input name="webFullURL" type="text" class="bodyText">
				  	<input name="bImportHTTP" type="submit" class="tdHeader" id="bImportHTTP" value="Import Message">
				  </form><br>
			    </td>
              </tr>
            </table>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">       
		<tr> 
          <td height="25" colspan="3" class="tdBackGrnd"><strong>Subscription
               List: Create a New Message/Newsletter to broadcast to your subscribers</strong><strong></strong></td>
        </tr>
        <form action="messageNew.cfm" method="post">
		<cfoutput>
		<input type="hidden" name="lid" value="#lid#">
		  ...
		  <tr>
		    <td height="20" colspan="3" align="center" class="bodyText">Editor Status:
		      <input type="radio" name="ShowEditor" value="1" class="bodyText" <cfif ShowEditor eq 1>checked</cfif>>On <input type="radio" name="ShowEditor" value="0" class="bodyText" <cfif ShowEditor eq 0>checked</cfif>>
		      Off
		      (useful to disable editor when importing full web pages)</td>
		    </tr>
		  <tr>
			<td colspan="3" align="center" class="bodyText">
			Editor window size: <strong>Width</strong>	        
		...
		<tr> 
          ...
          <cfform action="subscriptionLists.cfm" method="post" name="messageNew" enctype="multipart/form-data">
		  <cfoutput>
		  <input type="hidden" name="EmailListID" value="#lid#">
		  ...
		  <tr>
			...
			<cfparam name="webFullURL" default="">
			<cfparam name="filename" default="index.cfm">
			<cfif IsDefined("bImportHTTP") AND Len(webFullURL) neq 0>
				<cfif Left(webFullURL, 7) eq "http://">
					<cfset webFullURL = RemoveChars(webFullURL, 1, 7)>
				<cfelse>
					<cfset webFullURL = "http://"&#webFullURL#>
				</cfif>
				<cfhttp 
				   url = "#Trim(webFullURL)#"
				   file="#filename#"
				...
				<cfscript>
					importedHTMLMsgOrig = #cfhttp.fileContent#;
					 // tmpEndSlash = #FindOneOf(webFullURL, '\\', 7)#;
					 // tmpWebURLLength = Len(webFullURL); 
					 // webURLTrimmed = #Left(webFullURL, Val(tmpEndSlash + 7))#;
					importedHTMLMsg = ReReplace(importedHTMLMsgOrig, 'ref="/', 'ref="#webFullURL#/', "all");
				</cfscript>
			</cfif>
			</td>
		    </tr>
		  ...
		  <tr align="center">
		    <td height="22" colspan="3" nowrap class="bodyText"><strong>Message (HTML
	        Version)</strong>:<br>
		  ...
		  <cfif (ShowEditor eq 0)>
		  <tr> 
            <td colspan="3" align="center" valign="top"><textarea name="MessageHTML" cols="90%" rows="30"><cfoutput>#importedHTMLMsg#</cfoutput></textarea>
            </td>
          </tr>
          <cfelse>
		  <tr>
			...
			<cfmodule 
				template="editor/fckeditor.cfm"
				basePath="editor/"
				instanceName="MessageHTML"
				value="#importedHTMLMsg#"
				width="#editorWidth#"
				height="#editorHeight#"
				canupload="false" 
				canbrowse="false" 
		  ...
		  <tr align="center" valign="top"> 
            <td colspan="3" nowrap class="bodyText"><textarea name="MessageTXT" cols="90%" rows="15"></textarea>
            </td>
            </tr>
          <tr> 
            <td height="1" colspan="3" align="right" class="tdHorizDivider"></td>
		  ...
		  <tr> 
            <td height="22" align="right" nowrap class="bodyText"><strong>Do
                you wish to send as a multi-part Message</strong>: </td>
            <td class="tdVertDivider"></td>
            <td align="left"><input name="MessageMultiPart" type="checkbox" value="1" checked></td>
          </tr>
          <tr> 
            <td height="1" colspan="3" align="right" class="tdHorizDivider"></td>
          </tr>
		  ...
		  <tr align="center">
		    <td height="25" colspan="3" nowrap bgcolor="#EEEEEE" class="bodyText"><input name="bSave" type="submit" class="tdHeader" id="bSave" value="Save Message"></td>
		    </tr>
          <tr> 
            <td height="1" colspan="3" align="right" class="tdHorizDivider"></td>
          </tr>
