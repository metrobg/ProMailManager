      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr align="left">
          <td height="25" colspan="15" bgcolor="#E7E7CF" class="bodyText">Search criteria:<br>
            ...
            <br>
            Select 1 or more list/s to include subscribers from in this search<br>
			<cfoutput query="qAvailableLists">
				<input type="checkbox" name="lid" value="#EmailListID#" <cfif qAvailableLists.EmailListID eq lid>checked</cfif>>#EmailListDesc#
