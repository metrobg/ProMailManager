 ...
 CREATE TABLE "ADMIN" 
   (	"ADMINID" NUMBER(5,0), 
     ...
     ALTER TABLE "ADMIN" ADD CONSTRAINT "ADMIN_PK" PRIMARY KEY ("ADMINID");
      ALTER TABLE "ADMIN" MODIFY ("ADMINID" NOT NULL ENABLE);
      ALTER TABLE "ADMIN" MODIFY ("ADMINLEVELID" NOT NULL ENABLE);
      ALTER TABLE "ADMIN" MODIFY ("ADMINNAME" NOT NULL ENABLE);
      ALTER TABLE "ADMIN" MODIFY ("ADMINPWD" NOT NULL ENABLE);
      ALTER TABLE "ADMIN" MODIFY ("ADMINEMAIL" NOT NULL ENABLE);    
   ...
   (	"ACCESSID" NUMBER(9,0), 
        ...
        ALTER TABLE "ADMIN_ACCESS_LEVELS" MODIFY ("ACCESSLEVELDESC" NOT NULL ENABLE);   
...
CREATE TABLE "AUTO_RESPONDER_ATTACHMENTS"
 ...
 CREATE TABLE "AUTO_RESPONDER_MESSAGES" 
   (	"MESSAGEID" NUMBER(9,0), 
	...
	"MESSAGECREATEDATE" DATE DEFAULT SYSDATE, 
	"SUBSCRIBEREQUEST" NUMBER(5,0), 
	"UNSUBSCRIBEREQUEST" NUMBER(5,0)
);   
      CREATE UNIQUE INDEX "AUTO_RESPONDER_MESSAGES_PK" ON "AUTO_RESPONDER_MESSAGES" ("MESSAGEID") ;
     ALTER TABLE "AUTO_RESPONDER_MESSAGES" ADD CONSTRAINT "AUTO_RESPONDER_MESSAGES_PK" PRIMARY KEY ("MESSAGEID");
	 
	  CREATE OR REPLACE TRIGGER "AUTO_RESPONDER_MSG_TRIGGER" before
	  INSERT ON AUTO_RESPONDER_MESSAGES FOR EACH row BEGIN
	  SELECT mail_seq.nextval INTO :new.MESSAGEID FROM dual;
	END;
/
 
	ALTER TRIGGER "AUTO_RESPONDER_MSG_TRIGGER" ENABLE;
